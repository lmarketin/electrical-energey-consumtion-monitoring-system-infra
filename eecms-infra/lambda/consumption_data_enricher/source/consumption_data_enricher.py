    ...
    def enrich_consumption_data(self):
        ...
        try:
            ...
            for row in rows[1:]:
                ...
                logger.info(f"==== primary_key_value:{primary_key_value}")
                dynamo_data = dynamo_data_map.get(primary_key_value, {})
                ...
                updated_rows.append(row + [name, county, address, customer_type])
